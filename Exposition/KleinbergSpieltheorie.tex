%!TEX root=./Emile.tex
\subsection{Spieltheorie -- Was ist deine Strategie?}
...
Ein Fallbeispiel für ein Spiel der Spieltheorie liefert das \emph{Gefangenendilemma} \autoref{fig:gefangenendilemma} (\autopageref{fig:gefangenendilemma}).
...
Beide Spielausgänge lassen sich in einem Baumdiagramm darstellen \autoref{fig:summenspiele} (\autopageref{fig:summenspiele}).
