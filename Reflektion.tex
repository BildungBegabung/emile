...
Lässt sich unsere gemeinsame Arbeit auf GitHub trotzdem mit seinen 100 Jahre alten, reformpädagogischen Ideen vereinen?
	...
	\begin{quote}
		``Arbeit in der Gruppe [aber] bedeutet nicht zwangsläufig, daß jeder die gleiche Arbeit verrichtet. Der Einzelne muß dabei im Gegenteil ein Maximum von seiner Persönlichkeit bewahren, aber im Dienst der Gemeinschaft stehen.'' \parencite[510]{Freinet-2000a}
	\end{quote}
...
\paragraph{Illich zu Github}
	...
	\epigraph{
			``Education for all means education by all.'' \parencite[17]{Illich-1971}.
		}
