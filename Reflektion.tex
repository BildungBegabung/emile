%!TEX root=./Emile.tex
\section{Kooperation im Selbstexperiment - Reflektion über unsere Kursarbeit mit Git(Hub)}
...
Lässt sich unsere gemeinsame Arbeit auf GitHub trotzdem mit seinen 100 Jahre alten, reformpädagogischen Ideen vereinen?
	...
	\begin{quote}
		``Arbeit in der Gruppe [aber] bedeutet nicht zwangsläufig, daß jeder die gleiche Arbeit verrichtet. Der Einzelne muß dabei im Gegenteil ein Maximum von seiner Persönlichkeit bewahren, aber im Dienst der Gemeinschaft stehen.'' \citep[510]{Freinet-2000a}
	\end{quote}
...
Freinet unterstreicht die Wichtigkeit des Selberwählens aus gegebenen Alternativen \citepy[vgl.][495]{Freinet-2000a}.
...
\paragraph*{Illich zu Github}
	...
	\epigraph{
			``Education for all means education by all.'' \citep[17]{Illich-1971}.
		}
...
``He may invite the learner to participate in his own research'' \citep[43]{Illich-1971}.
Jedoch stellen sich dennoch weitere Probleme in den Weg:
Schränkte man unser Projekt allein auf die Ausarbeitung auf Github ein, würde sich unser Kontakt ebenfalls wieder auf eine rein effizienzorientierte Ebene reduzieren: ``to reinforce the competitive nature of schools'' \citep[35]{Illich-1971}, vor der \citeauthor{Illich-1971} warnt.
