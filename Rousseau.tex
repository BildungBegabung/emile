%!TEX root=./Emile.tex
\subsection{Rousseaus idealistisches Gedankenexperiment}

\epigraph{
		``Man was born free and everywhere he lives in chain stores.''}
	{
...
Auch wenn uns die Antworten, die er im Contrat Sociale und Émile gibt, nicht unbedingt befriedigen können, so helfen sie doch zu präzisieren, wovon unser Kurs und dieser Text handeln.

\subsubsection{Émile -- Oder über die Erziehung}
...
Er schreibt: ``Der Mensch wird frei geboren, und überall ist er in Banden.'' \citep[1]{Rousseau-1762-b}.
...
Das heißt, das Kind lernt nichts über Moral, Religion, Ethik, ..., sondern es wird vor ``Laster[n] und [...] Irrtümern bewahr[t]'' \citep[54]{rousseau-1762}.
Und zwar in einer Art extremen Laissez-faire.
Wenn das Kind etwa von ihm benötigte Gegenstände zerstört,
``[b]eeilt euch nicht, ihm andere zu geben; laßt es empfinden, wie unangenehm es ist, sie nicht zu haben.'' \citep[54]{rousseau-1762}.

Bis zum 12. Lebensjahr soll das Kind so einfach leben, stark und gesund werden.
Ab dann beginnt man das Kind in Naturkunde zu unterrichten \citep[55]{rousseau-1762}.
In diesem Unterricht aber hat die Lehrerin/Erzieherin nur die Aufgabe, Lernsituationen zu schaffen.
Sie soll nichts erklären, sondern den Zögling allein herausfinden und verstehen lassen \citep[56]{rousseau-1762}.
...
Es ist nun in der Lage, eigene fundierte Entscheidungen, wie die Wahl seiner Religion, zu treffen \citep[60f.]{rousseau-1762}.

Bald darauf kommt die Zeit, dass Émile in die Gesellschaft eingeführt werden muss, da der Mensch nicht für immer allein bleiben kann \citep[61]{rousseau-1762}.
...
In einem so gelenkten Staat herrscht Gleichheit, da jedes Individuum und die Gesellschaft im Ganzen das Bestmögliche erhalten \citep[7]{Rousseau-1762-b}.
...
Dabei gilt für ihn ``Each man [woman] in giving himself [herself] to everyone gives himself to no-one.'' \citep[7][Anmerkung durch die Autoren]{Rousseau-1762-b}.
